...
if 1:
    ...
    SCG.load_model_params(f_name="/data/lisatmp4/kruegerd/RAM_TEST_RESULTS/VID_SCG_dk_2objects_with_noise_params.pkl")
    ...
    learn_rate = 0.0001 * .95**11
    momentum = 0.9
    for i in range(122400, 250000):
